            ...
            <div className="w-full max-w-6xl border border-gray-200 rounded-2xl overflow-hidden bg-white">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center p-12 md:p-16 lg:p-24">
                        ...
                        <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6 tracking-tight">
                        ...
                        <div>
                            <button
                                ...
                                className="bg-[#edc5c4] text-gray-900 px-10 py-4 rounded-full font-bold shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-transparent"
                            >
                                나만의 블렌드 찾기
                            </button>
                        </div>
                    ...
                    {/* Right Side: Media (Slow Crossfade Carousel with Embedded Modal) */}
                    <div className="w-full h-full min-h-[400px] md:min-h-full relative p-0 overflow-hidden rounded-b-2xl md:rounded-bl-none md:rounded-r-2xl bg-[#fcf9f9] flex items-center justify-center pointer-events-none">
                        <AnimatePresence>
